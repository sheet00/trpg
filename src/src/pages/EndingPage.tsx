...
export function EndingPage() {
  ...
  const [generatedEnding, setGeneratedEnding] = useState<StoryScene | null>(() => {
    const storedScene = getSceneState(endingSceneNumber).scene
  ...
  useEffect(() => {
    const storedScene = getSceneState(endingSceneNumber).scene
    setGeneratedEnding(storedScene?.is_ending ? storedScene : null)
  ...
  useEffect(() => {
    ...
    isLoading,
    previousSceneNumber,
    previousSceneState.scene?.next_is_ending,
    sceneStates,
    selectedJob?.name,
    setSceneState,
    setStories,
