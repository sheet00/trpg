...
export function EndingPage() {
  ...
  const [autoGeneratedEndingNumbers, setAutoGeneratedEndingNumbers] = useState<number[]>([])
  ...
  useEffect(() => {
    ...
    if (
      ...
      autoGeneratedEndingNumbers.includes(endingSceneNumber)
    ) {
      return
    }

    setAutoGeneratedEndingNumbers((current) => [...current, endingSceneNumber])
    void (async () => {
