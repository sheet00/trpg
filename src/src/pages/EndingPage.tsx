...
export function EndingPage() {
  ...
  const endingStartSceneNumber = useGameStore((state) => state.endingStartSceneNumber)
  ...
  const previousSceneNumber = endingStartSceneNumber ?? 5
  ...
  const shouldRedirectToStory = endingStartSceneNumber === null
  ...
  if (shouldRedirectToStory) {
    return <Navigate to="/story?scene=1" replace />
  }
