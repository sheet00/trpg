...
export function StoryPage() {
  ...
  useEffect(() => {
    ...
    setErrorMessage('')
  }, [backgroundData, currentSceneNumber, selectedJob])
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const truncatedStories = getStoredStorySceneStates()
          .filter((sceneState) => sceneState.sceneNumber <= currentSceneNumber)
          .map((sceneState) => sceneState.scene)
          .filter((scene): scene is StoryScene => scene !== null)

        setStoredStories(truncatedStories)
  ...
  }, [abilityRows, autoGeneratedSceneNumbers, availableActiveItemIds, backgroundData, currentSceneNumber, generatedScene, isSceneLoading, sceneItems, selectedJob])
